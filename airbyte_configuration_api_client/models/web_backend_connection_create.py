...
T = TypeVar("T", bound="WebBackendConnectionCreate")
...
class WebBackendConnectionCreate:
    ...
    operations: Union[Unset, List[OperationCreate]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for operations_item_data in _operations or []:
            operations_item = OperationCreate.from_dict(operations_item_data)

            operations.append(operations_item)

        web_backend_connection_create = cls(
            source_id=source_id,
        ...
        web_backend_connection_create.additional_properties = d
        return web_backend_connection_create
