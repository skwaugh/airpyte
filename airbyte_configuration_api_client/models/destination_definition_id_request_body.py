...
T = TypeVar("T", bound="DestinationDefinitionIdRequestBody")
...
class DestinationDefinitionIdRequestBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        destination_definition_id_request_body = cls(
            destination_definition_id=destination_definition_id,
        )

        destination_definition_id_request_body.additional_properties = d
        return destination_definition_id_request_body
