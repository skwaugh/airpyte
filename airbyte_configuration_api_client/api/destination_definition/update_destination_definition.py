...
from ...models.destination_definition_update import DestinationDefinitionUpdate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DestinationDefinitionUpdate,
) -> Dict[str, Any]:
    url = "{}/v1/destination_definitions/update".format(client.base_url)
