...
from ...models.source_definition_update import SourceDefinitionUpdate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: SourceDefinitionUpdate,
) -> Dict[str, Any]:
    url = "{}/v1/source_definitions/update".format(client.base_url)
