...
from ...models.web_backend_connection_update import WebBackendConnectionUpdate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WebBackendConnectionUpdate,
) -> Dict[str, Any]:
    url = "{}/v1/web_backend/connections/update".format(client.base_url)
