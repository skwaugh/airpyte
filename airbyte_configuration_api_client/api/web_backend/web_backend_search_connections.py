...
from ...models.web_backend_connection_search import WebBackendConnectionSearch
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WebBackendConnectionSearch,
) -> Dict[str, Any]:
    url = "{}/v1/web_backend/connections/search".format(client.base_url)
