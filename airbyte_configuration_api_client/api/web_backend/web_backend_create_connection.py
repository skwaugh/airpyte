...
from ...models.web_backend_connection_create import WebBackendConnectionCreate
...
def _get_kwargs(
    *,
    client: Client,
    json_body: WebBackendConnectionCreate,
) -> Dict[str, Any]:
    url = "{}/v1/web_backend/connections/create".format(client.base_url)
